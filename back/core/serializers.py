...
class FibonacciResultSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'parameter', 'result', 'execution_time', 'date_launched']
...
class ChangePasswordSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        if data['new_password'] != data['confirm_new_password']:
            raise serializers.ValidationError({"new_password": "Le nouveau mot de passe et la confirmation ne correspondent pas."})
        return data
