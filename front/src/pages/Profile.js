      ...
      <form className="sm:mx-auto sm:w-full sm:max-w-sm">
        <div className="rounded-sm flex  items-center justify-center">
          <div className="rounded-md flex h-12 w-12 border items-center justify-center shadow-sm">
            <img className="h-8" src={Fibonacci50} alt="Fibonacci 50" />
          </div>
        </div>
        <h2 className=" pb-12 mb-12 border-b mt-0 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
          Welcome, Ibrahim !
        </h2>
        <div className="space-y-12">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            <p className="mt-1 text-sm leading-6 text-gray-600">
              Edit your Fibonacci feature settings.
            </p>
          ...
          >
            <ArrowPathIcon className="h-4 w-4 me-2"/><span className="me-2">Generate new value </span>
          </button>
              </div>
            </div>
          </div>
